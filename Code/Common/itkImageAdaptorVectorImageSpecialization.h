#ifndef __itkImageAdaptorVectorImageSpecialization_h
#define __itkImageAdaptorVectorImageSpecialization_h
...
/** Specialization for VectorImage class. */
...
class ITK_EXPORT ImageAdaptor< VectorImage< TPixelType, VDimension >, TAccessor >
  : public RegularImageAdaptor< VectorImage< TPixelType, VDimension >, TAccessor >
{
public:
  ...
  typedef RegularImageAdaptor< VectorImage< TPixelType, VDimension >, TAccessor > Superclass;
  ...
  typedef VectorImage< TPixelType, VDimension > InternalImageType;
  ...
  { m_PixelAccessor.Set(this->m_Image->GetPixel(index), value); }

  /** Get a pixel (read only version)  */
  PixelType GetPixel(const IndexType & index) const
  { return m_PixelAccessor.Get( this->m_Image->GetPixel(index) ); }
  ...
  /** Set Internal Image */
  virtual void SetImage(InternalImageType *);
  ...
  {
    return this->m_Image->TransformPhysicalPointToContinuousIndex(point, index);
  }
  ...
  {
    return this->m_Image->TransformPhysicalPointToIndex(point, index);
  }
  ...
  {
    this->m_Image->TransformLocalVectorToPhysicalVector(inputGradient, outputGradient);
  }
...
private:
  ...
  typename InternalImageType::Pointer m_Image;
...
#endif // __itkImageAdaptorVectorImageSpecialization_h
