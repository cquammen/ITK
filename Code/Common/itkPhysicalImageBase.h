...
public:
   ...
   * For PhysicalImageBase and Image, the default data spacing is unity. */
   ...
   * castable to an PhysicalImageBase. Setting the RequestedRegion does not cause
   ...
   * ImageSource::GraftOutput(). The implementation in PhysicalImageBase
   * simply calls CopyInformation() and copies the region ivars.
   * Subclasses of PhysicalImageBase are responsible for copying the pixel
   * container. */
   ...
   * \endcode
   *
   * \sa PhysicalImageBase, VectorImage
   *
