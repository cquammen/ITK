/*=========================================================================
  ...
  Module:    itkRegularImageAdaptor.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkRegularImageAdaptor_h
#define __itkRegularImageAdaptor_h
...
{
/**
 * \class RegularImageAdaptor
 * \brief Give access to partial aspects of voxels from an RegularImage
 *
 * RegularImageAdaptors are templated over the RegularImageType and over a functor
 * that will specify what part of the pixel can be accessed
 *
 * The basic aspects of this class are the types it defines.
 *
 * RegularImage adaptors can be used as intermediate classes that allow
 ...
 *
 * \ingroup RegularImageAdaptors
 *
 */
template< class TImage, class TAccessor >
class ITK_EXPORT RegularImageAdaptor:public RegularImageBase< ::itk::GetImageDimension< TImage >::ImageDimension >
{
public:
  ...
  typedef RegularImageAdaptor                                        Self;
  ...
  itkTypeMacro(RegularImageAdaptor, RegularImageBase);
   ...
   * RegularImage or VectorRegularImage. */
   ...
   * castable to an RegularImageBase. */
  virtual void SetRequestedRegion(DataObject *data);

  /** Get the region object that defines the size and starting index
   * for the region of the image requested (i.e., the region of the
   * image to be operated on by a filter).
   * This method overloads the one in RegularImageBase in order to delegate
   ...
   * For RegularImageBase and RegularImage, the default direction is identity. */
  virtual const DirectionType & GetDirection() const;

  /** Set Internal RegularImage */
  virtual void SetImage(TImage *);

  /** Delegate Modified to the Internal RegularImage */
  virtual void Modified() const;

  /** Delegate GetMTime to the Internal RegularImage */
...
#include "itkRegularImageAdaptor.txx"
#endif
