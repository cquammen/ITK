/*=========================================================================
  ...
  Module:    itkRectilinearImage.txx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkRectilinearImage_txx
#define __itkRectilinearImage_txx
...
RectilinearImage< TPixel, VImageDimension >
::RectilinearImage()
{
...
::Graft(const DataObject *data)
{
  ...
  if ( data )
    {
    // Attempt to cast data to an RectilinearImage
    const Self *imgData;
    ...
    if ( imgData )
      ...
      itkExceptionMacro( << "itk::RectilinearImage::Graft() cannot cast "
                         << typeid( data ).name() << " to "
