#ifndef __itkImageAdaptorRectilinearImageSpecialization_h
#define __itkImageAdaptorRectilinearImageSpecialization_h
...
class ITK_EXPORT ImageAdaptor< RectilinearImage< TPixelType, VDimension >, TAccessor >
  : public RectilinearImageAdaptor< RectilinearImage< TPixelType, VDimension >, TAccessor >
{
public:
  ...
  typedef RectilinearImageAdaptor<
    RectilinearImage< TPixelType, VDimension >, TAccessor > Superclass;
  typedef SmartPointer< Self >                              Pointer;
  typedef SmartPointer< const Self >                        ConstPointer;
  typedef WeakPointer< const Self >                         ConstWeakPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(ImageAdaptor, RectilinearImageAdaptor);
...
#endif // __itkImageAdaptorRectilinearImageSpecialization_h
