...
=========================================================================*/
#ifndef __itkRectilinearImage_h
#define __itkRectilinearImage_h
...
class ITK_EXPORT RectilinearImage:public RectilinearImageBase< VImageDimension >
{
public:
  /** Standard class typedefs */
  typedef RectilinearImage                        Self;
  typedef RectilinearImageBase< VImageDimension > Superclass;
  ...
  itkTypeMacro(Image, RectilinearImageBase);
...
protected:
  ...
  virtual ~RectilinearImage() {}

private:
  RectilinearImage(const Self &);          //purposely not implemented
...
#include "Templates/itkRectilinearImage+-.h"
#endif

#if ITK_TEMPLATE_TXX
#include "itkRectilinearImage.txx"
#endif
