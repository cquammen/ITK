/*=========================================================================
  ...
  Module:    itkVectorRegularImage.txx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkVectorRegularImage_txx
#define __itkVectorRegularImage_txx
#include "itkVectorRegularImage.h"
...
VectorRegularImage< TPixel, VImageDimension >
::VectorRegularImage():
  m_VectorLength(0)
{
...
::Allocate()
{
  if ( m_VectorLength == 0 )
    {
    itkExceptionMacro(<< "Cannot allocate VectorRegularImage with VectorLength = 0");
    }
...
::Graft(const DataObject *data)
{
  ...
  if ( data )
    ...
    // Copy from VectorRegularImage< TPixel, dim >
    if ( imgData )
      {
      ...
      itkExceptionMacro( << "itk::VectorRegularImage::Graft() cannot cast "
                         << typeid( data ).name() << " to "
