/*=========================================================================
  ...
  Module:    itkVectorRegularImage.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkVectorRegularImage_h
#define __itkVectorRegularImage_h
...
#include "itkVectorRegularImageNeighborhoodAccessorFunctor.h"
#include "itkPoint.h"
 ...
 *
 * Conceptually, a <tt>VectorRegularImage< double, 3 ></tt> is the same as a
 ...
 * \sa VectorRegularImageToImagePixelAccessor
 * \sa VectorRegularImageToImageAdaptor
 * \sa Image
 * \sa ImportImageContainer
 *
 * \example Testing/Code/Common/itkVectorRegularImageTest.cxx
 *
 * \ingroup ImageObjects
 */
template< class TPixel, unsigned int VImageDimension = 3 >
class ITK_EXPORT VectorRegularImage:
  public RegularImageBase< VImageDimension >
{
public:
  /** Standard class typedefs */
  typedef VectorRegularImage                  Self;
  ...
  itkTypeMacro(VectorRegularImage, ImageBase);
   ...
   * pointers. */
  typedef VectorRegularImageNeighborhoodAccessorFunctor<
...
protected:
  ...
  virtual ~VectorRegularImage() {}
private:
  VectorRegularImage(const Self &);    // purposely not implementated
...
#define ITK_TEMPLATE_VectorRegularImage(_, EXPORT, TypeX, TypeY)           \
  namespace itk                                                     \
  {                                                                 \
  _( 2 ( class EXPORT VectorRegularImage< ITK_TEMPLATE_2 TypeX > ) )       \
  namespace Templates                                               \
  {                                                                 \
  typedef VectorRegularImage< ITK_TEMPLATE_2 TypeX > VectorRegularImage##TypeY; \
  }                                                                 \
  }

#if ITK_TEMPLATE_EXPLICIT
#include "Templates/itkVectorRegularImage+-.h"
#endif

#if ITK_TEMPLATE_TXX
#include "itkVectorRegularImage.txx"
#endif
