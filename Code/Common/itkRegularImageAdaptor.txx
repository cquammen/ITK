/*=========================================================================
  ...
  Module:    itkRegularImageAdaptor.txx
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkRegularImageAdaptor_txx
#define __itkRegularImageAdaptor_txx
...
RegularImageAdaptor< TImage, TAccessor >
::RegularImageAdaptor()
{
...
::Graft(const DataObject *data)
{
  ...
  if ( data )
    {
    // Attempt to cast data to an RegularImageAdaptor
    const Self *imgData;
    ...
    if ( imgData )
      ...
      itkExceptionMacro( << "itk::RegularImageAdaptor::Graft() cannot cast "
                         << typeid( data ).name() << " to "
...
//----------------------------------------------------------------------------
template< class TImage, class TAccessor >
const typename RegularImageAdaptor< TImage, TAccessor >::OffsetValueType *
RegularImageAdaptor< TImage, TAccessor >
...
//----------------------------------------------------------------------------
template< class TImage, class TAccessor >
typename RegularImageAdaptor< TImage, TAccessor >::IndexType
RegularImageAdaptor< TImage, TAccessor >
...
//----------------------------------------------------------------------------
template< class TImage, class TAccessor >
const typename RegularImageAdaptor< TImage, TAccessor >::SpacingType &
RegularImageAdaptor< TImage, TAccessor >
...
//----------------------------------------------------------------------------
template< class TImage, class TAccessor >
const typename RegularImageAdaptor< TImage, TAccessor >::PointType &
RegularImageAdaptor< TImage, TAccessor >
...
//----------------------------------------------------------------------------
template< class TImage, class TAccessor >
const typename RegularImageAdaptor< TImage, TAccessor >::DirectionType &
RegularImageAdaptor< TImage, TAccessor >
...
//----------------------------------------------------------------------------
template< class TImage, class TAccessor >
const typename RegularImageAdaptor< TImage, TAccessor >::InternalPixelType  *
RegularImageAdaptor< TImage, TAccessor >
...
//----------------------------------------------------------------------------
template< class TImage, class TAccessor >
typename RegularImageAdaptor< TImage, TAccessor >::InternalPixelType  *
RegularImageAdaptor< TImage, TAccessor >
::GetBufferPointer()
{
  return m_Image->GetBufferPointer();
...
//----------------------------------------------------------------------------
template< class TImage, class TAccessor >
const typename RegularImageAdaptor< TImage, TAccessor >::RegionType &
RegularImageAdaptor< TImage, TAccessor >
