/*=========================================================================
  ...
  Module:    itkRectilinearImageAdaptor.h
  Language:  C++
  Date:      $Date$
  Version:   $Revision$
...
=========================================================================*/
#ifndef __itkRectilinearImageAdaptor_h
#define __itkRectilinearImageAdaptor_h
...
{
/**
 * \class RectilinearImageAdaptor
 * \brief Give access to partial aspects of voxels from an RectilinearImage
 *
 * RectilinearImageAdaptors are templated over the RectilinearImageType and over a functor
 * that will specify what part of the pixel can be accessed
 *
 * The basic aspects of this class are the types it defines.
 *
 * RectilinearImage adaptors can be used as intermediate classes that allow
 ...
 *
 * \ingroup RectilinearImageAdaptors
 *
 */
template< class TImage, class TAccessor >
class ITK_EXPORT RectilinearImageAdaptor:public RectilinearImageBase< ::itk::GetImageDimension< TImage >::ImageDimension >
{
public:
  ...
  typedef RectilinearImageAdaptor                                        Self;
  typedef RectilinearImageBase< itkGetStaticConstMacro(ImageDimension) > Superclass;
  typedef SmartPointer< Self >                                           Pointer;
  typedef SmartPointer< const Self >                                     ConstPointer;
  typedef WeakPointer< const Self >                                      ConstWeakPointer;

  /** Run-time type information (and related methods). */
  itkTypeMacro(RectilinearImageAdaptor, RectilinearImageBase);
   ...
   * RectilinearImage or VectorRectilinearImage. */
  ...
  typedef typename Superclass::DefaultSpacingType DefaultSpacingType;
   ...
   * castable to an RectilinearImageBase. */
  virtual void SetRequestedRegion(DataObject *data);

  /** Get the region object that defines the size and starting index
   * for the region of the image requested (i.e., the region of the
   * image to be operated on by a filter).
   * This method overloads the one in RectilinearImageBase in order to delegate
   ...
   * RectilinearImageSource::GraftOutput(). The implementation in RectilinearImageBase
  ...
  virtual void SetDefaultSpacing(const DefaultSpacingType & values);

  virtual void SetDefaultSpacing(const double *values /*[ImageDimension]*/);

  virtual void SetDefaultSpacing(const float *values /*[ImageDimension]*/);
   ...
   * For RectilinearImageBase and RectilinearImage, the default direction is identity. */
  virtual const DirectionType & GetDirection() const;

  /** Set Internal RectilinearImage */
  virtual void SetImage(TImage *);

  /** Delegate Modified to the Internal RectilinearImage */
  virtual void Modified() const;

  /** Delegate GetMTime to the Internal RectilinearImage */
...
protected:
  ...
  virtual ~RectilinearImageAdaptor();
  void PrintSelf(std::ostream & os, Indent indent) const;

protected:

  // Adapted image, most of the calls to RectilinearImageAdaptor
...
private:
  RectilinearImageAdaptor(const Self &);   //purposely not implemented
...
#include "itkRectilinearImageAdaptor.txx"
#endif
