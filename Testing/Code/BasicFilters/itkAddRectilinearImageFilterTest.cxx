...
int itkAddRectilinearImageFilterTest(int, char* [] )
{
  ...
  typedef itk::RectilinearImage<float, myDimension>  myImageType1;
  typedef itk::RectilinearImage<float, myDimension>  myImageType2;
  typedef itk::RectilinearImage<float, myDimension>  myImageType3;
