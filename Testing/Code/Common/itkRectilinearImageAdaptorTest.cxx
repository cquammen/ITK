...
//-------------------------------------
typedef itk::RectilinearImage< itk::RGBPixel<float>,   2 > myImageType;
...
//
//-------------------------
int itkRectilinearImageAdaptorTest(int, char* []) {
  ...
  myImage->SetDefaultSpacing(fspacing);
  if (myImage->GetDefaultSpacing() != myAdaptor->GetDefaultSpacing())
    {
    std::cout << "image default spacing != adaptor default spacing: "
              << myImage->GetDefaultSpacing() << " != "
              << myAdaptor->GetDefaultSpacing()
              << std::endl;
    return EXIT_FAILURE;
    }

  double dspacing[2] = {2.0, 3.0};
  myImage->SetDefaultSpacing(dspacing);
  if (myImage->GetDefaultSpacing() != myAdaptor->GetDefaultSpacing())
    {
    std::cout << "image default spacing != adaptor default spacing: "
              << myImage->GetDefaultSpacing() << " != "
  ...
  myImage->SetDefaultSpacing(imageSpacing);
  if (myImage->GetDefaultSpacing() != myAdaptor->GetDefaultSpacing())
    {
    std::cout << "image default spacing != adaptor default spacing: "
              << myImage->GetDefaultSpacing() << " != "
  ...
  fspacing[0] = 20.0;
  myAdaptor->SetDefaultSpacing(fspacing);
  if (myImage->GetDefaultSpacing() != myAdaptor->GetDefaultSpacing())
    {
    std::cout << "image default spacing != adaptor default spacing: "
              << myImage->GetDefaultSpacing() << " != "
  ...
  dspacing[0] = 20.0;
  myAdaptor->SetDefaultSpacing(dspacing);
  if (myImage->GetDefaultSpacing() != myAdaptor->GetDefaultSpacing())
    {
    std::cout << "image default spacing != adaptor default spacing: "
              << myImage->GetDefaultSpacing() << " != "
  ...
  myAdaptor->SetDefaultSpacing(imageSpacing);
  if (myImage->GetDefaultSpacing() != myAdaptor->GetDefaultSpacing())
    {
    std::cout << "image default spacing != adaptor default spacing: "
              << myImage->GetDefaultSpacing() << " != "
